...
<head>
    ...
    <title>Sertifikat Kedisiplinan</title>
    <style>
        @page {
            margin: 0;
            size: A4 landscape;
        ...
        /* Helper untuk vertikal alignment */
        ...
        .main-content {
            margin-top: 38mm; /* Turunkan agar tidak kena ornamen atas */
            padding: 0 10mm;
        }
        ...
        h2 {
            color: #b79c5a;
            font-size: 26pt; /* Sedikit diperkecil */
            text-transform: uppercase;
            margin: 0;
            font-family: serif;
            font-weight: normal;
        ...
        .footer-section {
            position: absolute;
            bottom: 42mm; /* Naikkan agar aman dari ornamen bawah */
            left: 0;
            width: 100%;
            text-align: center;
        }
        ...
        .role-text {
            ...
            color: #1a365d;
            font-size: 13pt;
            margin-bottom: 16mm; /* Rapatkan space tanda tangan */
        }
